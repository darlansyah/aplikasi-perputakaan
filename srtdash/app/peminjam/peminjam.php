...
INNER JOIN buku ON peminjam.kode_register = buku.kode_register");
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href=""><i class="fa fa-table"></i><span>Peminjam</span></a></li>
                            <li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="sales-report-area mt-5 mb-5">
                   <div class="card">
                   <div class="card-body">
                   <h6 class="header-title mb-0">Daftar Peminjaman</h6>
                   </div>   
                            <div class="card-body">
            ...
            <tr>
                ...
                <td><?= hitungDenda($row['tgl_kembali']);?></td>
                <td><a class="btn btn-rounded btn-warning mb-3" href="edit.php?kode=<?=$row['kode_pinjam'];?>">Edit</a>
                    <a class="btn btn-rounded btn-info mb-3" href="kembali.php?kode=<?=$row['kode_pinjam'];?> && denda= <?=hitungDenda($row['tgl_kembali'])?>">Kembali</a>    
            </tr>
            <?php
            endforeach;
            ?>
