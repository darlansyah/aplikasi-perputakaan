...
if ($_SESSION['level'] ==1) {
   ...
   if (isset($kode)) { // cek apa ada kode dikitimkan di url    
   if (!cek_buku($kode)) { // cek jumlah buku   
   echo "<script>"
            . "alert('Jumlah Buku Kosong!');"
   ...
   if (isset($_POST['tambah'])) {
        ...
        if (!cek_buku($_POST['buku'])) { // cek jumlah buku   
            echo "<script>"
                     . "alert('Jumlah Buku Kosong!');"
                             . "document.location.href = '../buku/buku.php';"
                             . "</script>";
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="sales-report-area mt-5 mb-5">
                   <div class="card">
                   <div class="card-body">
                   <h6 class="header-title mb-0">Tambah Peminjaman</h6>
                   </div>   
                            <div class="card-body">
        <form action="" method="POST"> 
                                            ...
                                            <select class="custom-select" name="petugas">
                                                ...
                                                <?php
                                                 foreach ($petugas as $row):
                                                     ?>
                                                <option value="<?= $row['kode_petugas'];?>"><?= $row['nama'];?></option>
                                                 <?php    
                                                 endforeach;
                                                ?>
                                            </select>
            ...
            <div class="form-group">
                                            ...
                                            <select class="custom-select" name="anggota">
                                                ...
                                                foreach ($anggota as $ang):
                                                    ?>
                                                <option value="<?= $ang['no_anggota'];?>"> <?= $ang['nama'];?></option>
                                                <?php
                                                endforeach;
                                                ?>
                                            </select>
            ...
            <div class="form-group">
                                            ...
                                            <select class="custom-select" name="buku">
                                                ...
                                                foreach ($buku as $row):
                                                ?>
                                                <option value="<?= $row['kode_register'];?>"> <?= $row['judul'];?></option>
                                                <?php
                                                endforeach;
                                                ?>
                                            </select>
