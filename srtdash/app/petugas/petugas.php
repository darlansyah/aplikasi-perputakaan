...
$petugas = tampil("SELECT * FROM petugas");
    ...
    <div class="page-container">
       ...
       <div class="main-content-inner">
                ...
                <div class="sales-report-area mt-5 mb-5">
                   <div class="card">
                   <div class="card-body">
                   <h4 class="header-title mb-0">Daftar Petugas</h4>
                   </div>   
                            <div class="card-body">
            ...
            <tr>
                ...
                <td><?= $row['jl'];?></td>
                <td><?= $row['no_hp'];?></td>
                <td><a class="btn btn-rounded btn-warning mb-3" href="edit.php?kode=<?=$row['kode_petugas'];?>">Edit</a>
                    <a class="btn btn-rounded btn-danger mb-3" href="hapus.php?kode=<?=$row['kode_petugas']; ?>" onclick="return confirm('Apakah Data Ingin Dihapus?')">Hapus</a></td>
            </tr>
            <?php
        endforeach;
            ?>
