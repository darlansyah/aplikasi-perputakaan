...
if ($_SESSION['level'] ==1) {
    $alamat = "<li  class='active'><a href='../petugas/petugas.php'><i class='fa fa-table'></i><span>Petugas</span></a></li>";
}
...
$kode = $_GET['kode'];
$row = tampil("SELECT * FROM petugas WHERE kode_petugas = '$kode'")[0];

if (isset($_POST['update'])) {
    if (editPetugas($kode,$_POST) > 0) {
        echo "<script>"
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="sales-report-area mt-5 mb-5">
                   <div class="card">
                   <div class="card-body">
                   <h4 class="header-title mb-0">Edit Petugas</h4>
                     
        <form action="" method="POST">
            <div class="form-group">
                <label for="kode" class="col-form-label">No Anggota</label>
                <input class="form-control" type="text" name="kode" id="kode" value="<?=$row['kode_petugas'] ;?>"    required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" type="text" name="alamat" id="alamat" required> <?=$row['alamat'] ;?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="number" name="no_hp" id="no_hp" value="<?=$row['no_hp'] ;?>" required>
            </div>
