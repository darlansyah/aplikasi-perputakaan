...
$row = tampil("SELECT * FROM pengunjung WHERE id_pengunjung = $id")[0];
$status = tampil("SELECT * FROM status");
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <?=$alamat;?>
                            <li  class="active"><a href="../pengunjung/pengunjung.php"><i class="fa fa-table"></i><span>Pengunjung</span></a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="sales-report-area mt-5 mb-5">
                   <div class="card">
                   <div class="card-body">
                       <h4 class="header-title mb-0">Edit Pengunjung</h4>
       <form action="" method="POST">
            <input type="hidden" name="id" value="<?=$row['id_pengunjung']; ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="tel" name="no_hp" id="no_hp" value="<?=$row['noHP'];?>" required>
            </div>
            <div class="form-group">
                                            ...
                                            <select class="custom-select" name="status">
                                                <?php 
                                                    ...
                                                    <option value="<?= $sta['id_status'] ;?>"
                                                            <?php
                                                            if ($sta['id_status'] == $row['id_status']){
                                                                echo "selected";
                                                            }
                                                            ?>  
                                                            >  <?= $sta['status'] ;?></option>
