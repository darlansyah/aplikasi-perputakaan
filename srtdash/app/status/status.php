...
$tampil = tampil("SELECT * FROM status");
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href=""><i class="fa fa-table"></i><span>Status</span></a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="sales-report-area mt-5 mb-5">
                   <div class="card">
                   <div class="card-body">
                        <h4 class="header-title mb-0">Daftar Status</h4>
                   </div>   
                            <div class="card-body">
            ...
            <tr>
                ...
                <td><?= $row['status'];?></td>
                <td>
                    <a class="btn btn-rounded btn-warning mb-3" href="edit.php?id=<?=$row['id_status']; ?>">Edit</a>
                    <a class="btn btn-rounded btn-danger mb-3" href="hapus.php?id=<?=$row['id_status']; ?>" onclick="return confirm('Apakah Yakin Dihapus?')">Hapus</a>
                </td>
            </tr>
            <?php
            endforeach;
