...
$row = tampil("SELECT * FROM status WHERE id_status = $id")[0];
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="../status/status.php"><i class="fa fa-table"></i><span>Status</span></a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="sales-report-area mt-5 mb-5">
                   <div class="card">
                   <div class="card-body">
                   <h4 class="header-title mb-0">Edit Status</h4>
                   </div>   
                            <div class="card-body">
      
        <form action="" method="POST">
        
            <input type="hidden" name="id" value="<?= $row['id_status'];?>">
            <div class="form-group">
                <label for="status" class="col-form-label">Nama Status</label>
                <input class="form-control" type="text" name="status" value="<?= $row['status'];?>" id="status" required>
            </div>
